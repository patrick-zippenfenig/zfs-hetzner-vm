...
# needed since recovery debootstrap missing jammy
...
if [[ $v_encrypt_rpool == "1" ]]; then
  ...
  wget http://ftp.de.debian.org/debian/pool/main/d/dropbear/dropbear-bin_2022.82-4.1_arm64.deb
  wget http://ftp.de.debian.org/debian/pool/main/d/dropbear/dropbear-initramfs_2022.82-4.1_all.deb

  chroot_execute "dpkg -i /root/libtommath1_1.2.0-6_amd64.deb"
  chroot_execute "dpkg -i /root/dropbear-bin_2022.82-4.1_arm64.deb"
  chroot_execute "dpkg -i /root/dropbear-initramfs_2022.82-4.1_all.deb"
